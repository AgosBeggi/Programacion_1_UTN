...
/// \fn int OrdenarMayusculas(char[])
/// \brief Pide una cadena de caracteres, la recorre y asigna
/// matuscula en el primer caracter y minusculas en elresto
/// de los caracteres
/// \param cadena
/// \return Retorna 1 si se logró hacer, y 0 si no se logró.
int OrdenarMayusculas(char cadena[]);
